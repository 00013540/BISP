...
const Button = (theme: Theme) => {
  return {
    MuiButton: {
      ...
      variants: [
        {
          props: { color: 'primary', variant: 'contained', disabled: false },
          style: {
        ...
        {
          props: { color: 'primary', variant: 'contained', disabled: true },
          style: {
        ...
        {
          props: { color: 'primary', variant: 'outlined', disabled: false },
          style: {
        ...
        {
          props: { color: 'primary', variant: 'outlined', disabled: true },
          style: {
            backgroundColor: `${theme.palette.gray['2']} !important`,
        ...
        {
          props: { color: 'secondary', variant: 'outlined', disabled: false },
          style: {
        ...
        {
          props: { color: 'secondary', variant: 'outlined', disabled: true },
          style: {
            backgroundColor: `${theme.palette.gray['2']} !important`,
            border: `1px solid ${theme.palette.secondary['2']} !important`,
            color: `${theme.palette.secondary['2']} !important`,
